 ...
 */
/*
* Execute the following over every "hidraw" device until you find the
* one with "HID_NAME=Logitech USB Receiver"
*
* $ cat /sys/class/hidraw/hidraw0/device/uevent
*
* ARG[1] = /dev/hidrawX, which is the one found from above
*/
